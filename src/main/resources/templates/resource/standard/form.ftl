...
<form class="app-form" id="standard-form" enctype="multipart/form-data"  method="post" >
  <div class="field">
    <input class="easyui-textbox" name="stNo" style="width:100%" data-options="label:'标准号:',required:true ">
   </div>
  <div class="field">
  ...
  <div class="field">
   ...
   <div class="field">
   <select  class="easyui-combobox" name="status" style="width:100%" data-options="label:'标准状态:',required:true ">
